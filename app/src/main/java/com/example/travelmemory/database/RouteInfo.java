...
public class RouteInfo {
    public static final String TABLE_NAME = "travel_route";
    public static final String COLUMN_NAME_ID = "id";
    public static final String COLUMN_NAME_NAME = "name";
    public static final String COLUMN_NAME_LATITUDE = "latitude";
    public static final String COLUMN_NAME_LONGITUDE = "longitude";
    public static final String COLUMN_NAME_TRAVEL_LIST = "travel_list";
    public static final String COLUMN_NAME_ROUTE_ORDER = "route_order";
    ...
    public static final String SQL_CREATE_TABLE =
            "CREATE TABLE " + TABLE_NAME + " (" +
                    ...
                    COLUMN_NAME_TRAVEL_LIST + " INTEGER," +
                    COLUMN_NAME_ROUTE_ORDER + " INTEGER," +
